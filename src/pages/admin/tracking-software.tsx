...
const TrackingSoftwareAdmin: React.FC = ({ networkData }: any) => {
...
export default TrackingSoftwareAdmin;
...
export const getStaticProps = async () => {
  ...
  const res = await fetch(
    'https://lionfish-app-qfe6m.ondigitalocean.app/v1/admin/tracking-software',
    {
      method: 'GET',
      headers: {
