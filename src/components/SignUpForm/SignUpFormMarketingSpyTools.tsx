...
import InputField from '../common/Forms/InputFieldMarketingSpyTools';
...
const schema = z.object({
  ...
  program_type: z
    .string()
    .regex(/Marketing Spy Tools/, 'Program type must be Marketing Spy Tools'),
    ...
    <>
      ...
      <form className="my-12" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="space-y-4">
          ...
          <InputField
            label={'Marketing Spy Tools Name'}
            id="network_name"
            placeholder=""
            type="text"
            register={register}
          ...
          <div>
            <label
              ...
              className="mt-4 block text-base font-bold leading-relaxed text-zinc-800">
              Marketing Spy Tools Description
            </label>
            <textarea
          ...
          <InputField
            label="Payment Frequency (Monthly/Yearly)"
          ...
          <InputField
            label="Referral Commission (2%, 5%, more)"
...
export default SignUpFormMarketingSpyTools;
