...
export type AffiliateProgramFormData = z.infer<typeof schema>;

const SignUpFormAffiliateProgram = () => {
  const {
    register,
    handleSubmit,
    control,
    ...
    <>
      ...
      <form className="my-12" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="space-y-4">
          ...
          <InputField
            label="Program Category (Dating, Web Hosting, Health & Beauty, Forex, more)"
            id="tag"
            placeholder=""
            type="text"
            register={register}
...
export default SignUpFormAffiliateProgram;
